...
set edit:completion:arg-completer[rwalk] = {|@words|
    ...
    var completions = [
        &'rwalk'= {
            ...
            cand -f 'Response filtering: "time", "status", "contains", "starts", "end", "regex", "length", "hash", "header", "json", "depth"'
            cand --filter 'Response filtering: "time", "status", "contains", "starts", "end", "regex", "length", "hash", "header", "json", "depth"'
