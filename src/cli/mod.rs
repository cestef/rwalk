...
#[derive(Debug, Parser, Clone, Merge, Deserialize, Serialize, Facet)]
...
pub struct Opts {
    ...
    #[merge(strategy = merge_overwrite)]
    #[facet(opaque, proxy = crate::cli::proxy::IntRangeU16VecProxy)]
    ...
    #[merge(strategy = merge::vec::append)]
    #[facet(opaque, proxy = crate::cli::proxy::TransformsProxy)]
    ...
    #[merge(strategy = merge::vec::append)]
    #[facet(opaque, proxy = crate::cli::proxy::MergeProxy)]
    ...
    #[merge(strategy = merge::vec::append)]
    #[facet(opaque, proxy = crate::cli::proxy::HeadersProxy)]
